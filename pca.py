...
X_low = pca1.fit(data[0:36])
result = np.array(pca1.transform(data))
print (np.shape(result))

for n in range(6):
	plt.plot(result[n*3:n*3+3,0],result[n*3:n*3+3,1],'go')
for n in range(6,12):
	plt.plot(result[n*3:n*3+3,0],result[n*3:n*3+3,1],'o',color='magenta')
plt.show()
