...
X,sampleList,_ = load('PCAdat.dat')
...
#for n in range(36):
ax.scatter([X[0:36,0]],[X[0:36,1]],[X[0:36,2]],c=colorS,cmap='viridis',marker='o',alpha=1)
#ax.set_xticks([])
#ax.set_yticks([])
#ax.set_zticks([])
