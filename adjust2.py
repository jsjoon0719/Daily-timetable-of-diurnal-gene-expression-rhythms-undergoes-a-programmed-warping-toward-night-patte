...
def go_adjust(event=None):
	global min_entry,mid_entry,max_entry,mainFig
...
def adjustColor(mat2):
	global min_entry,mid_entry,max_entry, mat, cmap,mainFig
	mat = mat2
	root = tk.Tk()
	...
	go_adjust_button.place(x=50,y=80,width=100)
...
if __name__ == '__main__':
	[dataStorm, lifegram, periodgram, timeList, p2l, l2p] = load('4')
